                ...
                {previewLoading ? (
                  ...
                  getEffectiveMimeType(previewFile).startsWith("image/") ? (
                    ...
                    <video 
                      ...
                      className={isMobile ? "w-full max-h-[70vh]" : "max-w-full max-h-[70vh] w-full"}
                      ...
                      onError={(e) => {
                        ...
                        fallbackDiv.className = 'flex flex-col items-center gap-4 p-8';
                        fallbackDiv.innerHTML = `
                          ...
                          <p class="text-white/70 text-center">Não foi possível reproduzir o vídeo.<br/>Faça download para visualizar.</p>
                        `;
                        videoEl.parentNode?.appendChild(fallbackDiv);
                      }}
                    />
